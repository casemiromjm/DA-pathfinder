...
[Locations.csv](/For%20Students/Locations.csv) contains a header with 3 columns: *Location*, *Id*, *Code*, *Parking*.
...
[Distances.csv](/For%20Students/Distances.csv) contains information about the travelling time (or distance) between two locations. The file contains a header with 4 columns: *Location1*, *Location2*, *Driving*, *Walking*.
